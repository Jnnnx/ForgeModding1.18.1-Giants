package com.jnnx.giantsmod.goal.giantGoal;
...
public class BreakBlockGoal extends BlockInteractGoal{
    ...
    public BreakBlockGoal(Mob p_25091_, Predicate<Difficulty> p_25092_) {
        super(p_25091_);
        this.validDifficulties = p_25092_;
    }

    public BreakBlockGoal(Mob p_25087_, int p_25088_, Predicate<Difficulty> p_25089_) {
